"""PNG heat map rendering: a pre-composited RGBA raster (see rendering/blend.py)."""
...
def _date_ticks(processed_dates: list[date], n_ticks: int = 6) -> tuple[list[int], list[str]]:
